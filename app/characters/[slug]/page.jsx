...
// generateStaticParams function is used to specify the dynamic routes 
...
// fetch data from the specified API endpoint using fetch
...
// params object as a prop contains the dynamic parameter values extracted from the URL
