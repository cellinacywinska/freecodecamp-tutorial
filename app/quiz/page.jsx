...
// fetching a random question from the API
export async function getRandomQuizQuestion() {
  // { cache: 'no-store' } - disabling caching for this specific request
  // to ensure that every time a user accesses this page, a new question will be fetched
